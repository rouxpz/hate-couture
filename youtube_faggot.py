...
filename = 'youtube_faggot_test.txt'
...
tokenizer = Tokenizer()
postagger = POSTagger()
tagger = DictionaryTagger(['positive.yml', 'tier2.yml', 'test.yml'])

### Open page & generate soup
### the "start" variable will be used to iterate through 10 pages.
for start in range(0,2):
    url = "http://www.google.com/search?q=faggot+site:youtube.com/all_comments&hl=en&authuser=0&biw=1532&bih=745&tbs=sbd:1,qdr:d&filter=0&start=" + str(start*10)
